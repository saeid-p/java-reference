...
public class DateTime {
  ...
  public static void workingWithDates() throws ParseException {
    ...
    // Before example
    System.out.printf(
      "Is %1$tF before %2$tF? %3$b%n",
      today,
      birthdate,
      Boolean.valueOf(today.before(birthdate))
    );
    System.out.printf(
      "Is %1$tF before %1$tF? %3$b%n",
      today,
      today,
      Boolean.valueOf(today.before(today))
    );
    System.out.printf(
      "Is %2$tF before %1$tF? %3$b%n",
      today,
      birthdate,
    ...
    // After example
    System.out.printf(
      "Is %1$tF after %2$tF? %3$b%n",
      today,
      birthdate,
      Boolean.valueOf(today.after(birthdate))
    );
    System.out.printf(
      "Is %1$tF after %1$tF? %3$b%n",
      today,
      birthdate,
      Boolean.valueOf(today.after(today))
    );
    System.out.printf(
      "Is %2$tF after %1$tF? %3$b%n",
      today,
      birthdate,
    ...
    // Compare example
    System.out.printf(
      "Compare %1$tF to %2$tF: %3$d%n",
      today,
      birthdate,
      Integer.valueOf(today.compareTo(birthdate))
    );
    System.out.printf(
      "Compare %1$tF to %1$tF: %3$d%n",
      today,
      birthdate,
      Integer.valueOf(today.compareTo(today))
    );
    System.out.printf(
      "Compare %2$tF to %1$tF: %3$d%n",
      today,
      birthdate,
    ...
    System.out.printf(
      ...
      Long.valueOf(birthdate.getTime()),
      Long.valueOf(samebirthdate.getTime())
    );
    ...
    System.out.printf(
      "Is %1$tF equal to %2$tF after clearing ms? %3$b%n",
      birthdate,
      samebirthdate,
      Boolean.valueOf(birthdate.equals(samebirthdate))
    );
    ...
    // equals example
    System.out.printf(
      "Is %1$tF equal to %2$tF? %3$b%n",
      localNow,
      birthdate2,
      Boolean.valueOf(localNow.equals(birthdate2))
    );
    System.out.printf(
      "Is %1$tF to %2$tF? %3$b%n",
      birthdate2,
      birthdate3,
    ...
    ZonedDateTime parsed = ZonedDateTime.parse(
      "2016-07-27T07:00:00+01:00[Europe/Stockholm]"
    );

    ZoneOffset zoneOffset = ZoneOffset.ofHours(2);
    OffsetDateTime dateTimeWithZone = OffsetDateTime.of(
      2016,
      7,
      27,
      7,
    ...
    OffsetDateTime compositionWithZone = OffsetDateTime.of(
      localDate,
      localTime,
      zoneOffset
    );
    OffsetDateTime nowWithZone = OffsetDateTime.now(); // Offset taken from the default ZoneId
    OffsetDateTime parsedWithZone = OffsetDateTime.parse(
      "2016-07-27T07:00:00+02:00"
    );
  }
}
